...
\begin{lemma}
  ...
  \uses{def:RCF}
  \lean{IsRealClosed.Ri_isSquare, IsRealClosed.no_quadratic_ext_Ri}
  \leanok
...
\begin{corollary}
  \label{cor:FTAlg_alg}
  \uses{def:RCF}
  \lean{IsRealClosed.finite_of_isAlgebraic}
  \leanok
...
\begin{lemma}
  \label{lem:RCF_max}
  \uses{def:RCF}
  \lean{IsRealClosed.bijective_algebraMap_of_isSemireal_of_isAlgebraic}
  \leanok
